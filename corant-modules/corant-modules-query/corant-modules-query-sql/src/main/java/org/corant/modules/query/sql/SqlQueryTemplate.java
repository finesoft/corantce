...
public class SqlQueryTemplate {
   ...
   * @param offset the offset used for query result handling or specific database query
   *        instructions, means skips the offset rows before beginning to return the rows.Default
   *        return 0.
   */
  ...
  public static class StreamConfig {
    ...
    /**
     * Set up an ordinary query parameter adjustment consumer, where the first parameter of
     * {@code parameterReviser} is the last record of the result set of the previous batch of
     * queries; the second parameter is the query parameter, user can modify it according to the
     * last record and other conditions, the modified parameters can be used for the next batch of
     * queries.
    ...
    /**
     * Set up an ordinary query parameter adjustment function, where the first parameter of
     * {@code parameterReviser} is the last record of the result set of the previous batch of
     * queries; the second parameter is the query parameter, user can modify it according to the
     * last record and other conditions, the modified parameters can be used for the next batch of
     * queries; the function return value will be used to update the {@link SqlQueryTemplate#offset}
     ...
     *
     * @param retryBackoffStrategy the retry back-off strategy, default is one second
     *
     * @see BackoffStrategy
